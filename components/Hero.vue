...
<template>
    <div
        class="lg:bg-gradient-to-r from-[#27272a] from-[500px] to-[800px] xl:from-[650px] xl:to-[70%] 2xl:from-[850px] 2xl:to-[1200px] 3xl:from-[1200px] w-full h-full pb-8 mb-8 bg-contain  bg-no-repeat bg-right lg:relative">
        ...
        <div
            ...
            <swiper-container class="mySwiper max-w-fullh-full" loop="true" effect="coverflow" grab-cursor="false"
                ...
                clickable="true" @swiperslidechange="onSlideChange" :style="hoverStyle">
